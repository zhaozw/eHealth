    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        doc_stub.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				findViewById(R.id.doc_stub_fullscreen).setVisibility(View.VISIBLE);
...
//		        }
//                startActivity(new Intent(InCallActivity.this, ImageStubActivity.class));
			}
		});
...
//			attachVideoPreview();
//			onDisplayVideo(true);
//	        if(cameraPreview != null && cameraPreview.getVisibility() == View.GONE) {
//	            
